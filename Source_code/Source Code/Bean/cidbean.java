...
public class cidbean {
	...
	private String id,name,date,age,height,weight,gender,zone,caseno,section,casedetails,crimedetails,pic,filename,filetype,filesize,filecontent,encrypt,decrypt,status;
