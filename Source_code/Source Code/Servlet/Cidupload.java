...
/**
 * Servlet implementation class Cidupload
 */
@WebServlet("/Cidupload")
public class Cidupload extends HttpServlet {
...
MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"Forensic\\WebContent\\Local\\";
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\Forensic\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\Forensic\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\Forensic\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
            ...
            if(ms==1)
            {
            	response.sendRedirect("cidmain.jsp");
